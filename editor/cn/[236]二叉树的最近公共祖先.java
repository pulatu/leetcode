...
// 
//
// Related Topics 树 深度优先搜索 二叉树 👍 2219 👎 0
...
//                && (!dfs(root.left,p) || !dfs(root.left,q))
//                && (!dfs(root.right,p) || !dfs(root.right,q)))
//        {
...
//            return false;
//        }
//        if(root==target || dfs(root.left,target) || dfs(root.right,target)){
//            return true;
//        }
//        return false;
//    }
